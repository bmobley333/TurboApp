...
// Menu Functions //////////////////////////////////////////////////////////////////////////////////////////////////
// PartyLog Menu
function fPSMenuClearPartyLogs() {fPSRunMenuOrButton('ClearPartyLogs');}
// System Menu
function fPSMenuAuthorize() {fPSRunMenuOrButton('Authorize');}
function fPSMenuRefreshAll() {fPSRunMenuOrButton('RefreshMenu');}
// Designer Menu
function fPSMenuHideAll() {fPSRunMenuOrButton('HideAll');}
function fPSMenuUn_HideAll() {fPSRunMenuOrButton('Un_HideAll');}
// End Menu Functions
...
function fPSRunMenuOrButton(menuChoice) { 
  try {
    switch (menuChoice) {
      // PartyLog Menu
      case 'ClearPartyLogs': fPSClearPartyLogs(); break;
      // System Menu
      case 'Authorize': SpreadsheetApp.getUi().alert(`AUTHORIZED`, `Script Authorized!`, SpreadsheetApp.getUi().ButtonSet.OK); break;
      case 'RefreshMenu': fPSCreateMenu(); break;
      // Designer Menu
      case 'HideAll': gHideAll('ps'); break;
      case 'Un_HideAll': gUn_HideAll('ps'); break;
    }
  } catch (error) {
...
function fPSClearPartyLogs(ss) {
  ...
  gFillArraySection(partyLogArr,partyLogFirst_R,partyLogLast_R,partyLogFirst_C,partyLogLast_C,'');
  gSaveArraySectionToSheet(partyLogRef,partyLogArr,partyLogFirst_R,partyLogLast_R,partyLogFirst_C,partyLogLast_C);
